    ...
    RainyDay.prototype.prepareReflections = function () {
      ...
      console.log('[RRC] - Creating element')
    ...
    RainyDay.prototype.rain = function (presets, speed) {
      ...
      console.log('[RC] Collected Options', this.options)
      if (this.reflection !== this.REFLECTION_NONE) {
        this.prepareReflections()
        console.log('[RC] - Preparing Reflections')
      }
      console.log('[RC] - Starting animation toolkit')
      this.animateDrops()
    ...
    RainyDay.prototype.prepareBackground = function () {
      console.log('[RC] - Preparing first pass on background')
